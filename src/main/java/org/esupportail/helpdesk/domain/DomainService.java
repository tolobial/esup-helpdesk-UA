...
public interface DomainService extends Serializable {
	...
	List<ArchivedTicket> getArchivedTickets(long startIndex, int maxResults);
      ...
      /**
     * Recupere les tickets archivables pour une annee academique donnee.
     * @param year l annee academique (ex : "2023")
     * @return liste des tickets archivables
     */
  List<Ticket> getArchivableTicketsByAcademicYear(String year);

    /**
     * Archive les tickets pour une annee academique donnee.
     * @param year l annee academique
     */
   void archiveTicketsByAcademicYear(String year);
