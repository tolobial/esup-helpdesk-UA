...
uploadedFiles.path=/var/local/helpdesk/upload
#
...
indexing.path=/applis/helpdesk/upload/helpdeskv3/index
#
...
#
lock.path=/var/local/helpdesk/lock
#lock.path=/tmp
#
...
cache.path=/tmp/helpdesk/assistance-UA/cache
#-------------------------------------------------------------
# STATIC RESOURCES
#-------------------------------------------------------------
#
...
mediaPath.portlet=/assistance-UA/media
#-------------------------------------------------------------
# URLS
#-------------------------------------------------------------
#
...
app.servletUrl=http://mesdemande.univ-antilles.fr/
...
urlGeneration.casLoginUrl=https://auth.univ-antilles.fr/cas/login?service=%s
#
...
urlGeneration.servletLoginUrl=http://mesdemandes.univ-antilles.fr/stylesheets/cas.faces
#
...
#
#og.file=/home/esup/tomcat/logs/esup-helpdesk.log
log.file=/home/esup/tomcat/logs/assistance-UA.log
#
...
#
exceptionHandling.email=patrick.placide@univ-antilles.fr
#
...
#-------------------------------------------------------------
#
# The class of the driver to use (defaults to com.mysql.cj.jdbc.Driver).
#
#hibernate.connection.driver_class=com.mysql.cj.jdbc.Driver
#hibernate.connection.driver_class=com.mysql.cj.jdbc.Driver
hibernate.dialect=custom.dialect.FixedMySQLInnoDBDialect
#
# The Hibernate dialect to use (defaults to org.hibernate.dialect.MySQLInnoDBDialect).
#
#hibernate.dialect=org.hibernate.dialect.MySQLInnoDBDialect
#hihibernate.dialect=org.hibernate.dialect.MySQL57Dialect
...
#
#hibernate.connection.jdbc.url=jdbc:mysql://helpdesk.martinique.univ-antilles.fr/FiaRH
#hibernate.connection.jdbc.url=jdbc:mysql://localhost/FiaRH
#hibernate.connection.jdbc.url=jdbc:mysql://localhost/esup-helpdesk-AMU
hibernate.connection.jdbc.url=jdbc:mysql://localhost/assistances_UA
#
# The credentials to connect to the database.
#
hibernate.connection.jdbc.username=root
#hibernate.connection.jdbc.password=Pabayli@1
hibernate.connection.jdbc.password=Admincetout01
#
...
cas.url=https://auth.univ-antilles.fr/cas
#
...
ldap.userName=uid=fd-admin,ou=People,dc=univ-antilles,dc=fr
ldap.password=pabayli1
...
# The base used to search users (required, e.g. dc=domain,dc=edu).
#
#ldap.base=dc=univ-ag,dc=fr
ldap.base=dc=univ-antilles,dc=fr
#
...
#
ldap.attributes=cn,uid,displayName,mail,supannEmpCorps,supannEntiteAffectation,supannEntiteAffectationPrincipale,supannEmpid,l,composante,co,eduPersonAffiliation,eduPersonPrimaryAffiliation,memberOf,sn
#ldap.attributes=uid,displayName,mail,supannEmpCorps,supannEntiteAffectation,supannEntiteAffectationPrincipale,supannEmpid,campus,composante,pole2,eduPersonAffiliation,eduPersonPrimaryAffiliation,memberOf,derninscripi,sn,cn
...
ldap.filterDate=supannEtuAnneeInscription
ldap.filterEdupersonaffiliation=eduPersonAffiliation
ldap.filterEdupersonaffiliationValues=member,employee,researcher,student,faculty
...
#
ldap.searchDisplayedAttributes=displayName,mail,supannEntiteAffectation,supannEntiteAffectationPrincipale,l,co,supannEmpCorps,supannEmpid,eduPersonAffiliation,eduPersonPrimaryAffiliation,memberOf
#-------------------------------------------------------------
# TEST
#-------------------------------------------------------------
#
...
#
portal.webServiceUrl=http://ent.univ-antilles.fr:8081/uPortal/services/UportalService
#-------------------------------------------------------------
# TEST
#-------------------------------------------------------------
#
...
#
smtp.host=smtp.martinique.univ-antilles.fr
#
...
#
smtp.fromEmail=assistance.teletravail@univ-antilles.fr
smtp.fromName=mesdemandes2
#-------------------------------------------------------------
# INTERCEPTION
#-------------------------------------------------------------
#
...
#
smtp.interceptEmail=patrick.placide@univ-antilles.fr
...
#
smtp.testEmail=assistance.teletravail@univ-antilles.fr
smtp.testName=Mesdemandes2_UA
##############################################################
# TICKETS
##############################################################
#-------------------------------------------------------------
...
#
init.firstAdministratorId=pplacide
#-------------------------------------------------------------
# USER FORMATTING
#-------------------------------------------------------------
#
...
#
userInfo.ldapAttributes=supannEntiteAffectation,co,eduPersonPrimaryAffiliation
#
# The user id used by the ant target test-user-info.
#
userInfo.testUserId=pplacide
##############################################################
# DEPARTMENTS
##############################################################
...
#
computerUrl.casServiceUrl=https://auth.univ-antilles.fr/cas/?service=%s
##############################################################
# FAQ
##############################################################
#
...
#
feed.imap.address=ufi-demande@univ-antilles.fr
#
# The FQDN or IP address of the IMAP server (e.g. imap.domain.edu).
#
feed.imap.server=smtp.martinique.univ-antilles.fr
#
# The credentials used to connect to the IMAP server.
#
feed.imap.account=_ufi-demande
feed.imap.password=Esup&Helpdesk97
#
...
#
webService.authorizedClientNames=127.0.0.1,193.51.63.219,139.124.243.77,139.124.244.77,10.193.1.64,portail-uag1.martinique.univ-ag.fr,portail-uag2.martinique.univ-ag.fr,apps.martinique.univ-ag.fr,w7cri-m16.personnel.martinique.univ-ag.fr,auth2.martinique.univ-antilles.fr,auth3.martinique.univ-antilles.fr
...
ent.url=https://ent.univ-antilles.univ.fr

# Données de l'univeristé affichées dans divers endroits de l'application
institution.name=Universitu00E des Antilles
footer.title=xxx Universit\u00E9 - DSIN
